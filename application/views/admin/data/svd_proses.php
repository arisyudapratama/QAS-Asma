...
echo "<pre>";
$this->db->query("DELETE FROM svd");
echo "Matrix U:";
echo "<br/>";
print_r($matrixClass->matrixRound($USV['U']));
$myJSON = json_encode($matrixClass->matrixRound($USV['U']));
$this->db->query("INSERT INTO svd (U) VALUES ('$myJSON')");     
echo "<br/><br/>";
...
$myJSON3 = json_encode($matrixClass->matrixRound($USV['S']));
$this->db->query("UPDATE svd SET S = '$myJSON3'");  
echo "<br/><br/>";
