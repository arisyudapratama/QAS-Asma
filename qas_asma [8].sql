...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2019 at 02:39 AM
...
(1, 'Saya kemarin jalan jalan tiba-tiba nafas saya terengah-engah padahal baru saja menaiki tanjakan sejauh 100 meter kira-kira itu pertanda penyakit asma');
...
(1, 'tempat untuk lalu lintas orang (kendaraan dsb)'),
(2, 'perlintasan (dari suatu tempat ke tempat lain)'),
(3, 'yang dilalui atau dipakai untuk keluar masuk'),
(4, 'lintasan'),
(5, 'orbit (tentang benda di ruang angkasa)'),
(6, 'gerak maju atau mundur (tentang kendaraan)'),
(7, 'putaran jarum'),
(8, 'perkembangan atau berlangsungnya (tentang perundingan, rapat, cerita, dsb) dari awal sampai akhir'),
(9, 'cara (akal, syarat, ikhtiar, dsb) untuk melakukan (mengerjakan, mencapai, mencari) sesuatu'),
(10, 'kesempatan (untuk mengerjakan sesuatu)'),
(11, 'lantaran'),
(12, 'perantara (yang menjadi alat atau jalan penghubung)'),
(13, 'berjalan'),
(14, 'melangkahkan kaki'),
(15, 'kelangsungan hidup (tentang organisasi, perkumpulan, dsb)'),
(16, 'dapat dipahami'),
(17, 'benar'),
(18, 'napas'),
(19, 'tahu (sadar atau mengerti)'),
(20, 'engah-engah'),
(21, 'terperengah'),
(22, 'menganjur ke atas (tentang jalan, destar, layar, dsb)'),
(23, 'satuan dasar ukuran panjang 39,37 inci'),
(24, 'yang menjadi alamat atau yang menyatakan sesuatu'),
(25, 'gejala'),
(26, 'bukti'),
(27, 'pengenal'),
(28, 'lambang'),
(29, 'petunjuk'),
(30, 'berasa tidak nyaman di tubuh atau bagian tubuh karena menderita sesuatu (demam, sakit perut, dsb)'),
(31, 'nama (bagi Tuhan)'),
(32, 'gangguan pernapasan yang sering bersifat alergis, ditandai dengan sulit bernapas dan rasa sesak dalam dada'),
(33, 'penyakit sesak napas'),
(34, 'bengek'),
(35, 'asthma bronchiale');
...
(1, 'jalan nafas engah tanjak meter tanda sakit asma');
...
--
ALTER TABLE `api`
  MODIFY `id_api` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
