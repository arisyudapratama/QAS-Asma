...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Sep 2019 pada 19.23
...
--
-- Struktur dari tabel `aktivasi_query`
--
...
(4301, 1, 'asma kambuh resep obat minum ambroxol teosal bahaya'),
(4302, 2, 'obat orang riwayat asma hipertensi obat tekan darah tahun'),
(4303, 3, 'asma bronkial alami anak tahun bangun sesak nafas periksa spesialis spa obat jalan rajin nebu sedia o2 rontgen normal tes darah normal laku tes alergi'),
(4304, 4, 'obat buah asma kambuh uap uap resep obat obat minum minum badan asa lemas mual badan pegal obat asetilsistein alegi'),
(4305, 5, 'tahun camping derajat bangun nafas engah dada sakit jari kaki tangan sulit gerak mata sulit buka nafas atur sadar bahaya'),
(4306, 6, 'sesak tarik napas batuk batuk kering batuk susah tarik napas asma turun keluarga keluarga asma takut gejala asma bangun bersin bersin telinga asa tutup masuk air solusi'),
(4307, 7, 'tahun stock ventolin inhaler milik asma jarang pakai tahun intensitas gejala sesak muncul aktivitas minggu kali efek inhaler hidung sumbat bibir kebas kelopak mata bengkak alergi hadap ventolin inhaler minum ctm pakai ventolin khawatir pakai ventolin alergi asma sesak muncul'),
(4308, 8, 'konsumsi obat ledomer biji kejang laku obat'),
(4309, 9, 'pimpin sakit asma kerja jam kerja ruang asma tahun tahun kumat tahun meni alami asma alami asma hidung lega hidung lega asma kambuh sumbat salah lubang hidung tissu bersih alami alergi debu sinus pandu moga bantu'),
(4310, 10, 'sakit asma bayi'),
(4311, 11, 'nafas manual dangkal pikir tidur susah karna ngatur nafas esok ulang mood jelek demam cek sehat'),
(4312, 12, 'perempuan tahun asma kambuh batuk hiding air rutin konsumsi obat teosal dexamethasone ambroxol nyeri gejala minum obat tremor halus pegal lengan telapak tangan kiri wajar efek obat utama teosal dexamethasone bahaya'),
(4313, 13, 'alami sesak batuk pilek batuk pilek sek ringan sehat tidur nyenyak'),
(4314, 14, 'pijat area punggung derita asma'),
(4315, 15, 'derita asma kambuh kejang tangan genggam susah lepas binggung alergi makan minum debu asap bakar bau sengat cat minum obat minum obat bronsolvan kandung teofilin minum lambung iris kambuh jarang henti minum bronsolvan salbutamol sifat minum salbutamol tablet aman salbutamol minum ceteme ceteme obat anti alergi'),
(4316, 16, 'tahun derita asma smp ringan kambuh keluarga milik anak tahun asma parah kambuh obat salbutamol minum kambuh asma'),
(4317, 17, 'idap sakit asma turun susah nafas hidung mulut tutup nafas bunyi susah nafas saran obat'),
(4318, 18, 'inhaler asma dengar dengar jenis inhaler konsultasi'),
(4319, 19, 'suami sakit asma turun kakek kumat pilek batuk dahak minggu kumat sedia ventolin inhaler salbutamol inhaler efek tenggorok panas bakar nan makan sakit stop inhaler konsumsi salbutamol kumat gara-gara konsumsi salbutamol tenggorok panas bakar suami banget kumat kasihan badan kurus banget makan solusi obat aman sakit asma suami total'),
(4320, 20, 'normal orang okok bangun tidur alami asma batuk'),
(4321, 21, 'anak pakai seretide pilek anjur kali semprot kakak lupa semprot kali adik bahaya anak tahun'),
(4322, 22, 'methylprednisolone asma salbutamol efek detak jantung cepat tubuh gigil tunggu'),
(4323, 23, 'orang tua derita asma derita paru basah masuk sakit kelas sakit batuk periksa paru kiri smp vonis asma asma jarang kambuh kecuali musim hujan sakit batuk pilek usia tahun sesak nafas kambuh asa sakit sesak dada sulit nafas nyeri tulang dada nyeri tulang punggung asa pegal periksa asma parah orang tua derita asma arti derita asma turun derita asma turun sulit obat'),
(4324, 24, 'alami batuk nafas dengar bunyi ngik batuk kering puskesmas obat obat reaksi obat alternatif sesak nafas'),
(4325, 25, 'anak minggu anak suara nafas ngrok dengar sesak nafas tidur sedot kasi tidur suara nyaring laku lendir mulut tarik bayi solusi sedot pakai alat sedot dahak solusi'),
(4326, 26, 'anak laki tahun derita sesak nafas asma nebuliser jenis beli hubung sakit derita'),
(4327, 27, 'derita asma paksa laku olahraga fisik lari bahaya kambuh aktivitas'),
(4328, 28, 'tahun hamil minggu sesak nafas uap hamil muda aman uap'),
(4329, 29, 'ayah nafas bunyi dahak bengkak kelenjar leher dahak hasil cenderung encer batuk dahak'),
(4330, 30, 'lahir prematur paru paru sempurna sesak nafas lelah asma kambuh kambuh anak lahir prematur sakit asma cegah'),
(4331, 31, 'usia kandung masuk riwayat asma asma kambuh batuk pilek batuk pilek kambuh lahir normal'),
(4332, 32, 'sehat sesak napas batuk tahun alami asma jarang kambuh gejala sesak napas asma pengaruh ruang debu lingkung dingin faktor sesak napas batuk kambuh pola hidup sehat kantor kerja minim aktivitas fisik lemah gejala asma'),
(4333, 33, 'aman susu asma kambuh'),
(4334, 34, 'sakit gejala asma sd smp gelaja sma sesak nafas laku aktivitas berat hadap debu gejala asma asma kambuh'),
(4335, 35, 'tahun turun asma orang tua pusing kepala sesak nafas sakit dada asma obat reda nyeri obat maag makan perut perih luka'),
(4336, 36, 'sakit derita asma batuk lendir jely asma kambuh pakai obat ventolin inhaler obat konsumsi sakit'),
(4337, 37, 'indah derita asma periksa obat teosal obat batuk minum teosal asma selang jam jantung detak kencang lemas mulut pahit lambung asa nyeri obat bagus sakit asma'),
(4338, 38, 'obat atrovent campur obat sesak salbutamol sulfate colorpheniramine maleate meprofarm ambroxol hci takut salah overdosis sesak kepala pusing banget jantung debar'),
(4339, 39, 'anak batuk flu nafas payah bunyi ngik ngik ngik minggu obat solusi tangan obat ampuh batuk asma bayi'),
(4340, 40, 'derita asma terapi inhaler symbicort semenjak pakai inhaler mulut ruam tenggorok perih efek samping symbicort cocok'),
(4341, 41, 'istri dadak asma hubung intim'),
(4342, 42, 'pasien asma fase ekspirasi fase inspirasi tunggu'),
(4343, 43, 'sakit asma asma kabuh asma kabuh minum obat neo napacin minum neo napacin kali langsung efek samping jangka konsumsi neo napacin jangka rusa organ tubuh solusi sakit asma'),
(4344, 44, 'asma orang tua asma kambuh asma lendir produksi sesak nafas obat tangan produksi lendir minum ambroxol mempan obat herbal jahe serang makan obat salbutamol nebules'),
(4345, 45, 'orang tua derita asma usia jarang serang makan obat salbutamol minum obat salbutamol sesak nafas kali makan obat nebules alat rumah tunda makan obat nebules sesak makan obat nebules nafas engah tunda makan obat dinebules pengaruh elastisitas salur nafas baca asma obat salur nafas kaku saran orang tua makan obat dinebules'),
(4346, 46, 'tahun tan anak nafas susah dahak batuk'),
(4347, 47, 'suami usia tahun riwayat asma obat ventolin semprot obat minum dexamethason salbutamol ambroxol beli alat omron nec compact compressor nebulizer dosis obat campur alat ventolin nebules ampul'),
(4348, 48, 'kucing pelihara elus kucing hirup bulu kucing bulu kucing hirup langkah sakit sakit saran'),
(4349, 49, 'isosorbid salbutamol'),
(4350, 50, 'batuk pilek bersin periksa obat obat batuk pilek batuk parah tenggorok sakit suara klimaks demam derajat opname diagnosa sakit tipes obat batuk pilek tipes batuk pilek minum es langsung batuk cuman sebentar minum es teh cuman gelas batuk pilek batuk pilek hidung sensitif banget debu pilek ngelus kucing sebentar langsung hidung gatel bersin parah mata gatel kucek merah megang ngelus gendong kucing pikir pilek total stabil batuk pilek'),
(4351, 51, 'surat terang sehat asma lolos'),
(4352, 52, 'sesak stress menang sesak nafas sulit tarik nafas dengar suara hink hink sulit ambil nafas tenang orang nafas perlahan batuk hidung tutup boneka peluk kucing debu batuk alami bengek alami asma'),
(4353, 53, 'alami sesak napas tahun sakit paru mikir ronsen kenapa-napa medical cek up lamar usaha lolos kampung udara kampung dingin dada sesak cium asap rokok langsung asa sakit langsung suruh cek up ronsen konsultasi ronsenya alergi asap debu mikir alergi asap debu asma dingin dingin asa sesak telusur asma alami positif asma konsultasi'),
(4354, 54, 'usia tahun asma banget sesak nafas batuk mang cuaca dingin usia tahun obat sakit sesak dada sakit'),
(4355, 55, 'milik asma hamil minggu aman ventolin nebulizer hamil asma kambuh'),
(4356, 56, 'tidur sesak nafas tidur pikir pikir tembak kepala solusi'),
(4357, 57, 'tahun celaka tahun sakit dada sakit sakit susah atur nafas sesak kepala leher tegang masuk gejala asma sakit'),
(4358, 58, 'hamil anak alami sesak napas ugd nyata vonis asma riwayat genetik hidup alami serang asma milik alat uap bolak ugd kali sesak napas obat uap jual bebas aman janin'),
(4359, 59, 'pria tahun keluh nafas asa susah narik nafas mati periksa puskesmas napas'),
(4360, 60, 'usia tahun sakit asma derita konsumsi obat asma ventolin inhaler minggu serang jantung masuk icu aritmia ventolin inhaler derita aritmia'),
(4361, 61, 'flu berat papar angin kencang minum susu diet serat dada asa sakit kering napas batas bengek bengek napas flu pengaruh asma sakit asma'),
(4362, 62, 'usia tahun alami sesak tahun asma anjur obat nebulizer orang guru aktivitas rumah beli inhaler bahaya nebulizer rumah inhaler rumah berangkat ajar nebulizer asa sesak inhaler cerah'),
(4363, 63, 'usia tahun tahun idap asma turun orang karyawan rumah tangga full aktivitas nafkah urus anak asma batuk kambuh obat bpjs obat salbutamol ml dexamethasone ambroxol hcl resep beli stok rumah bahaya konsumsi obat konsultasi paru kambuh'),
(4364, 64, 'asma tahun faktor turun kambuh parah batuk sesak bawa spesialis jantung hasil echo detak jantung lemah rujuk spesialis paru ronsen spesialis jantung mendiagnosa infeksi paru gagal jantung paru asma'),
(4365, 65, 'derita asma akut minum coq10 dosis'),
(4366, 66, 'alami sesak nafas minum obat minum obat timbul dahak sesak reda asma'),
(4367, 67, 'riwayat asma kambuh minum obat asma tremor dosis rangin tremor obat cocok minum obat salbutamol tremor'),
(4368, 68, 'derita sakit asma balita usia tahun sakit asma kambuh kambuh usia tahun periksa tht pilek smp nyata polip rinitis alergi hubung kambuh asma tindak laku dingin tidur posisi idap asma'),
(4369, 69, 'obat antibiotik amoxan aman derita sakit asma'),
(4370, 70, 'derita asma asma jalar kulit tanda'),
(4371, 71, 'milik asma asma jarang kambuh kambuh batuk pilek nafas bunyi batuk pilek pakai inhaler idap asma pakai inhaler konsumsi obat salbutamol asma kambuh'),
(4372, 72, 'derita asma turun asma muncul tahun henti rokok asma kambuh usia tahun batuk timbul asma sesak haid solusi hamil sabutamol obat keras hambat hamil'),
(4373, 73, 'anak tahun periksa keluh batuk pilek nyata periksa mendiagnosa gejala asma batuk pilek minggu batuk pilek jangka nyata riwayat asma kakek antisipasi anak tahun obat asma periksa obat encer dahak'),
(4374, 74, 'avamys pakai'),
(4375, 75, 'fluimucil bronkitis bagus sakit asma baca leaflet nyata hati-hatu asma henti fluimucil'),
(4376, 76, 'obat sakit asma kambuh opname obat inhaler berotec kambuh pakai obat mempan efek obat pakai salbutamol konsumsi salbutamol tablet uap salur nafas kaku moga sehat'),
(4377, 77, 'cuaca dingin alami flu derita asma tidur pakai obat semprot kambuh jam pakai obat obat flu'),
(4378, 78, 'tahun haid asma kambuh'),
(4379, 79, 'derita asma hamil inhaler obat semprot asma'),
(4380, 80, 'test pack positif asma kambuh pergi positif hamil nebu obat salbutamol usia hamil minggu asma kambuh minum salbutamol aman nebu aman nebu rumah'),
(4381, 81, 'milik sakit asma hidung sumbat utama tidur bangun sesak nafas gara-gara asma kambuh terkadang alami flu terkadang hidung sumbat tidur penanggulanganya saudara vaksin pneumonia pneumokokus kontrol cegah asma picu asma kambuh hidung sumbat flu'),
(4382, 82, 'pergi asma kambuh bawa inhaler obat asma bingung'),
(4383, 83, 'alami batuk asma nafas pendek minum obat salbutamol actifed sirup asma'),
(4384, 84, 'asma kambuh minum salbutamol jam ubah jam minum sesak solusi minum salbutamol'),
(4385, 85, 'demam sesak nafas bengkak mata solusi'),
(4386, 86, 'derita asma kelas smp kambuh jarang kambuh tahun sakit asma'),
(4387, 87, 'sakit asma nafas bunyi sebentar dada bangun tidur dingin kaya kompres es batu perut buncit coba makan keras perut sakit asma asma'),
(4388, 88, 'tes fisik periksa mata gigi ronsen dada pengaruh tes salah poltekkes gagal berfikir ronsen thorax orang derita asma'),
(4389, 89, 'siswi sma daerah tamat tahun asma sakit banget orang orang derita asma pasuk fakultas soalnyakan lulus tes masuk universitas khusus fakultas tes psikolog tes fisik orang derita asma pasuk'),
(4390, 90, 'sakit asma banget sesak nafas operasi rujuk spesialis paru tangan asma nyata asma bawa lahir salur nafas sempit banget nafas berat banget susah ambil nafas obat symbicort turbuhaler mcg serang langsung pakai obat asma cepat reda dada plong ambil nafas obat obat sakit rumah obat pakai inhaler obat tablet coba apotek jaga apotek pakai inhaler situ bingung banget serang asma dadak konsumsi obat asma tablet ginjal sisi mudah sakit konsumsi tablet solusi'),
(4391, 91, 'hamil minggu asma semenjak kambuh asma kambuh tahan inhaler semprot kali bahaya janin bahaya laku asma kambuh lahir normal kemudi bantu'),
(4392, 92, 'hormat derita asma balita injak usia remaja tahun asma kambuh usia tahun asma kambuh tidur pulas jam tidur posisi tidur nyaman derita asma perhati'),
(4393, 93, 'salam pnderita sesak nafas asma obat inhaler dosis tahun lega jarang kambuh botol hirup untk tahun salah kontrol inhaler beli toko online'),
(4394, 94, 'usia tahun asma usia tahun tahun sesak tahun lahir anak sesak obat semprot hirup gantung obat konsul konsul paru alergi hamil anak'),
(4395, 95, 'badan gemetar konsumsi salbutamol'),
(4396, 96, 'tulang asa ngilu gatal kaki tangan napas asa sesak pusing sakit'),
(4397, 97, 'segi terapi gurah asma aman laku efek samping terapi gurah'),
(4398, 98, 'anak batuk utama tidur batuk potong potong anak milik bronkitis riwayat asma sakit maag usus anak sulit makan makan sendok jam orang normal paksa batuk minum obat efek jam minum obat jam'),
(4399, 99, 'susu anak minggu asma kambuh minum obat sabultamol ganggu bayi'),
(4400, 100, 'asma bronkitis kronis minggu obat seretide diskus asma kumat minggu nebu malas konsultasi spesialis paru beli pemakain obat asma');

-- --------------------------------------------------------

--
-- Struktur dari tabel `query_proses`
--
...
--
-- Dumping data untuk tabel `query_proses`
--
...
--
-- Indeks untuk tabel `aktivasi_query`
--
...
--
-- Indeks untuk tabel `query_proses`
--
...
--
-- AUTO_INCREMENT untuk tabel `aktivasi_query`
--
ALTER TABLE `aktivasi_query`
  MODIFY `id_aktivasi_query` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `data_proses`
  MODIFY `id_data_proses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4401;

--
-- AUTO_INCREMENT untuk tabel `query_proses`
--
ALTER TABLE `query_proses`
  MODIFY `id_query_proses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
COMMIT;
